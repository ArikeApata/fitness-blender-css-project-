        ...
        <div className="main">
          ...
          <div id="ad4" className="ads">
            <div className="description">
              <h2>FB Merch</h2>
              <p>
                We have new shirts, hoodies, water bottles and more in our
                updated Fitness Blender Tee Spring store.
              </p>
              <a href="">Shop Now</a>
            </div>
          ...
          <div id="ad5" className="ads">
            <div className="description">
              ...
              <p>
                Research-backed articles to help you care for your body and
                mind.
              </p>
